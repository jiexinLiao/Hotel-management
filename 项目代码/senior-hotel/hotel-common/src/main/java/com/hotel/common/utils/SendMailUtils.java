...
public class SendMailUtils {
     ...
     * @return
     */
    public static void sendEmail(String mailServer,final String loginAccount,final String loginAuthCode,String sender,String[] recipients,
                                String emailSubject,String emailContent,String emailContentType) throws MessagingException, GeneralSecurityException {
        //跟smtp服务器建立一个连接
    ...
    //    String receive = "gary17355@163.com";
    //    String send = "1175171518@qq.com";
    //    int res=sendEmail("smtp.qq.com", send, SMTP_PORT, send, new String[]{
    //            receive //这里就是一系列的收件人的邮箱了
