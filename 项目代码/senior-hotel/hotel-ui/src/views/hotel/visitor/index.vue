    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['hotel:visitor:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['hotel:visitor:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listVisitor, getVisitor, delVisitor, addVisitor, updateVisitor } from "@/api/hotel/visitor";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除游客编号为"' + visitorIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('hotel/visitor/export', {
        ...this.queryParams
