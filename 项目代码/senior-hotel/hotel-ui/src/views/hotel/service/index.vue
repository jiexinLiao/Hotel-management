<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['hotel:service:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['hotel:service:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="serviceList" @selection-change="handleSelectionChange">
      ...
      <!--<el-table-column label="服务介绍" align="center" prop="introduce" />-->
...
<script>
import { listService, getService, delService, addService, updateService } from "@/api/hotel/service";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除酒店服务编号为"' + serviceIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('hotel/service/export', {
        ...this.queryParams
